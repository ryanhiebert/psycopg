...
def connect_ng(conninfo: str) -> PGconn: ...
def execute_ng(pgconn: PGconn) -> List[PGresult]: ...
def send_ng(pgconn: PGconn) -> None: ...
def fetch_many_ng(pgconn: PGconn) -> List[PGresult]: ...
def fetch_ng(pgconn: PGconn) -> Optional[PGresult]: ...
def pipeline_communicate_ng(
    pgconn: PGconn, commands: Deque[PipelineCommand]
) -> List[List[PGresult]]: ...
def wait_ng_c(fileno: int, wait: int) -> int: ...
